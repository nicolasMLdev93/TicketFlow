...
// Imports //
// Chain validators
const { createRegisterChain, createLoginChain, createEventChain, createFindEventChain, createTicket_typeChain, createFindTicket_typeChain, createOrderChain, createFindTicketsChain, } = require("../middlewares/chain_val");
...
// Controllers
const { register_user, login_user, create_event, get_events, get_eventByName, create_ticketType, get_ticket_types, get_event, create_order, get_userTickets, } = require("../controllers/controllers");
// Routes //
